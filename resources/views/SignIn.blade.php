                ...
                <div class="p-12 lg:p-16 flex flex-col justify-center bg-gradient-to-br from-blue-50 to-purple-50">
                    <div class="mb-8">
                        ...
                        <p class="text-lg text-gray-600 leading-relaxed">
                            Sign in to access your dashboard and continue where you left off. Manage your account and explore all available features at your fingertips.
                        </p>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-gray-700">Secure login process</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-gray-700">Fast authentication</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-gray-700">Access your dashboard</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-12 lg:p-16">
                    <div class="max-w-md mx-auto">
                        ...
                        <div class="mb-8">
                            ...
                            <p class="text-gray-500">Sign in to your account and start using our platform.</p>
                        </div>
                        ...
                        <div class="mt-6 text-center">
                            <p class="text-sm text-gray-600">
                                ...
                                <a href="/signup" class="text-blue-600 font-semibold hover:text-blue-700 transition-colors">
                                    Sign Up
                                </a>
                            </p>
                        </div>
